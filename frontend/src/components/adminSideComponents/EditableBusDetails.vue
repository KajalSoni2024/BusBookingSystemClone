    ...
    <div v-else class="d-flex flex-column justify-center align-center">
        ...
        <v-row>
          ...
          <v-col md="5" class="pt-12">
            ...
            <div><v-btn class="mt-2" variant="outlined" color="green-darken-2" @click="editBusDetail(bus)">Edit Details</v-btn></div>
          </v-col>
        </v-row>
...
const editBusDetail = (bus)=>{
    router.push({name:"EditBusDetailForm",query:{busId:bus.busId}});
}
onMounted(async()=>{
